...
Input Format  
An integer that represents the number of colors that you want
to purchase for your project. 
 
Output Format  
A number that represents the cost of your purchase rounded up
to the nearest whole number. 
...
Explanation  
You need 50.00 to buy 10 colors of paint + 40.00
for the canvas and brushes + 9.00 for the tax.
'''

import math
paint_num=int(input())
tax=math.ceil((40.00+paint_num*5.00)*0.1)
summ=math.ceil(tax+40.00+paint_num*5.00)
print(summ)